...
/**
 * Description Date Created in 2018/11/15 17:45 User jiaoshiru
 */
public class socketClient {

    //private static CommL commL;
  ...
  public static void main(String[] args) {
    try {
      ...
      Socket socket = new Socket("61.160.201.94", 30103);
      ...
      socket = new Socket("61.160.201.94", 30103);
      System.out.println(" ===准备发送=== ");
      jsonObject.put("code", "32");
      jsonObject.put("key", 129);
      JSONArray array = new JSONArray();
      JSONObject obj = new JSONObject();
      obj.put("r","2002");
      obj.put("i","P6-5234");
      obj.put("c","Y");
      obj.put("t","1470000000000");
      array.add(obj);
      jsonObject.put("data", array);
      requst = jsonObject.toJSONString();
